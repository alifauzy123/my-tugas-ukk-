                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-all duration-200 data-row" data-id="{{ $k->id }}" data-status="{{ strtolower($k->status) }}">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('kasir.show', $k->id) }}" class="bg-cyan-100 hover:bg-cyan-500 text-cyan-700 hover:text-white p-2 rounded-lg transition-all duration-200 inline-flex items-center justify-center" title="Lihat Detail">
                                    <i class="fas fa-eye text-sm"></i>
                                </a>
                                <a href="{{ route('kasir.edit', $k->id) }}" class="bg-blue-100 hover:bg-blue-500 text-blue-700 hover:text-white p-2 rounded-lg transition-all duration-200 inline-flex items-center justify-center" title="Edit">
