...
<div class="max-w-7xl mx-auto">
    <div class="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <form method="GET" action="{{ route('laporan.kasir.index') }}" class="mt-4 grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('laporan.kasir.export', ['start_date' => $startDate, 'end_date' => $endDate, 'kasir_id' => $kasirId]) }}"
