    ...
    <div class="lg:col-span-2">
        <form action="{{ route('kategori.store') }}" method="POST" id="formKategori" class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_kategori" required placeholder="Contoh: Elektronik, Fashion, Makanan" 
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all text-sm"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4" placeholder="Jelaskan kategori ini secara singkat dan jelas..." 
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all text-sm resize-none"
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="status" value="Aktif" checked 
                                class="w-4 h-4 text-green-600 focus:ring-2 focus:ring-green-200">
            ...
            <div class="bg-gray-50 px-8 py-6 flex justify-between gap-4 border-t-2 border-gray-100">
                ...
                <button type="button" id="btnSubmit" class="px-6 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all duration-200 font-semibold text-sm flex items-center gap-2 shadow-lg">
